...
class PostAdapter(private var postList: List<UserData>, private var notificationViewModel: NotificationViewModel) : RecyclerView.Adapter<PostAdapter.ViewHolder>() {
    ...
    // Replace the contents of a view (invoked by the layout manager)
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            buttonLike.setOnClickListener {
                notificationViewModel.addLikeNotification(postList[position].uid)
            }
